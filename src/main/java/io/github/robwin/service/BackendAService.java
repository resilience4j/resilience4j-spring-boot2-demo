...
public class BackendAService implements Service {
  ...
  private static final String HELLO_WORLD = "Hello World from backend A";
  ...
  public Flux<String> fluxTimeout() {
    return Flux.just(HELLO_WORLD).delayElements(Duration.ofSeconds(10));
  }
  ...
  public Mono<String> monoTimeout() {
    return Mono.just(HELLO_WORLD).delayElement(Duration.ofSeconds(10));
  }
